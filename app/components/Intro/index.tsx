    ...
    return (
        <div className={` w-full text-white `}>
            <div className="">
                ...
                <p className="text-[.94rem] mt-4 font-[200] text-white/80 md:max-w-[400px]">A proficient Java Software
                    Engineer,
                    leveraging
                ...
                <div className="mt-8 flex justify-start">
                    <button
                        className="bg-teal-400/20 rounded-full px-4 py-1 text-[1rem] items-center text-teal-300 font-[400] flex gap-2"><p>Download
